...
import com.prescription.router.PriceEstimation;
...
public class RouterClient {
    ...
    public static void main(String[] args) {
        ...
        Inventory in11 = new Inventory(it1, 10, 2, Arrays.asList(new Price("Blue Shield", 2), new Price("United", 1)));
        ...
        Inventory in18 = new Inventory(it10, 5, 4, Arrays.asList(new Price("Aflac", 2), new Price("Care First", 3)));

        Inventory in21 = new Inventory(it2, 10, 2, Arrays.asList(new Price("Care First", 2), new Price("Aflac", 1)));
        ...
        Inventory in28 = new Inventory(it10, 10, 4, Arrays.asList(new Price("Blue Shield", 2), new Price("Aetna", 1)));

        Inventory in31 = new Inventory(it2, 10, 2, Arrays.asList(new Price("Aetna", 2), new Price("Care First", 1)));
        ...
        Inventory in38 = new Inventory(it11, 10, 4, Arrays.asList(new Price("Aflac", 2), new Price("Care First", 1)));

        Inventory in41 = new Inventory(it6, 10, 2, Arrays.asList(new Price("Aetna", 2), new Price("Care First", 3)));
        ...
        Inventory in44 = new Inventory(it14, 5, 4, Arrays.asList(new Price("Blue Shield", 2), new Price("United", 4)));
